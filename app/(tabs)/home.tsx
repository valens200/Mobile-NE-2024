...
export default function HomeScreen() {
  ...
  /**
   * setting time out and wait while all posts are retrieved
   */
  setTimeout(() => {
    setLoading(false);
  }, 1000);
  ...
  /**
   * Function to delte the post from database
   * @param null
   */
  ...
  /**
   * Using use Effect hook to retrieve posts frequently
   */
  useEffect(() => {
    getPosts();
  });
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <Card className="w-[380px]  ml-4 ">
                  ...
                  />
                  <Card.Content>
                    <T variant="titleLarge">{item?.title}</T>
                  ...
                  <View className=" flex flex-row items-center justify-between px-4 ">
                    ...
                    <Card.Actions className="hover:cursor-pointer">
                      <Button
            ...
            renderItem={({ item }) => (
              <Card className="w-[380px] mt-4 ">
                ...
                <View className=" flex flex-row items-center justify-between px-4 ">
                  ...
                  <Card.Actions className="hover:cursor-pointer">
                    <Button onPress={() => router.push(`/product/${item.id}`)}>
                      View
                    </Button>
